#!/bin/bash
# submit_BCI_i1M.sh
# Submission wrapper for the two-part BCI 1M-iteration UGATIT training.
...
#   bash hpc_jobs/submit_BCI_i1M.sh
#
# To check status:
#   squeue -u $USER
#
...
#   sbatch hpc_jobs/infer_BCI_i1M.sh

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PART1="$SCRIPT_DIR/train_full_BCI_i1M_part1.sh"
PART2="$SCRIPT_DIR/train_full_BCI_i1M_part2.sh"
...
echo "=== Submitting BCI 1M-iteration UGATIT training (2 parts) ==="
...
echo "Part 1 log:   tail -f \$VSC_DATA/projects/ugatit/logs/train_full_BCI_i1M_p1.$JOB1.out"
echo "Part 2 log:   tail -f \$VSC_DATA/projects/ugatit/logs/train_full_BCI_i1M_p2.$JOB2.out"
echo ""
echo "After both complete, submit inference:"
echo "  sbatch hpc_jobs/infer_BCI_i1M.sh"
