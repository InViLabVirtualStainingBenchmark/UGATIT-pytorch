#!/bin/bash
#SBATCH --job-name=ugatit_train_MIST-HER2_i1M_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21212/projects/ugatit/logs/train_full_MIST-HER2_i1M_p2.%j.out
#SBATCH -e /data/antwerpen/212/vsc21212/projects/ugatit/logs/train_full_MIST-HER2_i1M_p2.%j.err

# train_full_MIST-HER2_i1M_part2.sh
# Iterations 500,001-1,000,000 of UGATIT training on MIST-HER2.
...
# which after part 1 is MIST-HER2_full_i1M_params_0500000.pt. It then runs
# range(500000, 1000001) with decay starting at step 500001.
#
# DO NOT submit this manually before part 1 finishes -- use submit_MIST-HER2_i1M.sh.
# If part 1 failed or was cancelled, do not submit this script.
#
# After this job completes, next step: sbatch infer_MIST-HER2_i1M.sh
...
nvidia-smi --query-gpu=timestamp,utilization.gpu,memory.used,memory.total \
           --format=csv -l 5 \
    > "$VSC_DATA/projects/ugatit/logs/gpu_train_full_MIST-HER2_i1M_p2.csv" & GPU_LOG_PID=$!
...
echo ""
echo "=== Starting MIST training part 2 (iterations 500,001-1,000,000, LR decay) ==="
...
echo ""
echo "=== GPU log tail ==="
tail -3 "$VSC_DATA/projects/ugatit/logs/gpu_train_full_MIST-HER2_i1M_p2.csv"

echo ""
echo "MIST full training complete (iterations 1-1,000,000). Next step: sbatch infer_MIST-HER2_i1M.sh"
